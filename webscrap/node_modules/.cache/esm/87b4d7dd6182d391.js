let axios,cheerio;_618‍.x([["scrapperEbay",()=>scrapperEbay]]);_618‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_618‍.w("cheerio",[["default",["cheerio"],function(v){cheerio=v}]]);
...
const getHtml = async (
  ...
  try {
    ...
    _618‍.g.console.log(url);
    return data;
  } catch (err) {
    _618‍.g.console.log(err.response);
  }
};
...
const scrapperEbay = async (searchTerm) => {
  try {
    ...
    _618‍.g.console.log(numberOfMappedResults);
    ...
    if (numberOfMappedResults === 0) {
      ...
      _618‍.g.console.log(displayedResults.concat(nextPageRes));
      return displayedResults.concat(nextPageRes);
    }
  } catch (error) {
    _618‍.g.console.log(error);
  }
};
/*
const getKehData = () => {};
