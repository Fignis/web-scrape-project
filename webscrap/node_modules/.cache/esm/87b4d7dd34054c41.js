let axios,cheerio;_340‍.x([["getHtml",()=>getHtml],["getEbayPrices",()=>getEbayPrices],["formatResults",()=>formatResults],["getClHtml",()=>getClHtml]]);_340‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_340‍.w("cheerio",[["default",["cheerio"],function(v){cheerio=v}]]);
...
const getHtml = async (searchTerm) => {
  ...
  try {
    ...
    _340‍.g.console.log(err.response);
  }
};
