let axios,cheerio;_b72‍.x([["getHtml",()=>getHtml],["getEbayPrices",()=>getEbayPrices],["formatResults",()=>formatResults]]);_b72‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_b72‍.w("cheerio",[["default",["cheerio"],function(v){cheerio=v}]]);
...
const getHtml = async (searchTerm) => {
  try {
    ...
    _b72‍.g.console.log(err.response);
  }
};
